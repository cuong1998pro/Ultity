...
namespace DoiSangLichAm
{
    public partial class frmMain : Form
    {
        ...
        private void btnDoiSangAmLich_Click(object sender, EventArgs e)
        {
            ConvertAmLichHelper vcal = new ConvertAmLichHelper();
            var day = dpkNgayDuongLich.Value.Day;
            var month = dpkNgayDuongLich.Value.Month;
            var year = dpkNgayDuongLich.Value.Year;
            var result = vcal.convertSolar2Lunar(day, month, year, 7);
            dpkNgayAmLich.Value = result;
        }
    }

    public class ConvertAmLichHelper
    {
        public DateTime convertSolar2Lunar(int dd, int mm, int yy, int timeZone)
        {
            ...
            return new DateTime((int)lunarYear, (int)lunarMonth, (int)lunarDay);
        }
